document.addEventListener("DOMContentLoaded", () => {
    ...
    function closeAdminPasswordErrorPopup() {
        if (adminPasswordErrorPopup) {
    ...
    function closeAdminUserNotFoundPopup() {
        if (adminUserNotFoundPopup) {
    ...
    if (adminPasswordPopupCloseBtn) {
        adminPasswordPopupCloseBtn.addEventListener('click', closeAdminPasswordErrorPopup);
    }

    // Close the admin user not found popup when the close button is clicked
    if (adminUserNotFoundPopupCloseBtn) {
        adminUserNotFoundPopupCloseBtn.addEventListener('click', closeAdminUserNotFoundPopup);
    }
