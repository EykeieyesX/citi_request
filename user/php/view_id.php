...
// Fetch the request_number from the URL
$request_number = $_GET['request_number'];
$username = $_SESSION['username'];

// Prepared statement to prevent SQL injection
$sql = "SELECT * FROM barangay_id WHERE request_number = ? AND username = ?";
...
$validuntil = new DateTime($request['validuntil']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="view-request-header">
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($request['middlename']); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo $dateofbirth->format('F j, Y'); ?></td>
            </tr>
            <tr>
                <td><strong>Civil Status:</strong></td>
                <td><?php echo htmlspecialchars($request['civilstatus']); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><strong>Resident Number:</strong></td>
                <td><?php echo htmlspecialchars($request['residentnumber']); ?></td>
            </tr>
            <tr>
                <td><strong>Precinct Number:</strong></td>
                <td><?php echo htmlspecialchars($request['precinctnumber']); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo $validuntil->format('F j, Y'); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($request['paid']); ?></td>
            </tr>
            <tr>
...
<div class="action-buttons">
    ...
    <?php if ($request['status'] === 'Completed'): ?>
        <a href="feedback_id.php?request_number=<?php echo htmlspecialchars($request['request_number']); ?>" class="feedback-btn">Provide Feedback for this Request</a>
    <?php endif; ?>
</div>
<script>
    // Function to download data as CSV
    function downloadCSV() {
        const requestNumber = "<?php echo htmlspecialchars($request['request_number']); ?>";
        const csvContent = [
            ["Field", "Value"],
            ...
            ["Middle Name", "<?php echo htmlspecialchars($request['middlename']); ?>"],
            ["Middle Initial", "<?php echo htmlspecialchars($request['middleinitial']); ?>"],
            ["Date of Birth", "<?php echo $dateofbirth->format('F/j/Y'); ?>"],
            ["Civil Status", "<?php echo htmlspecialchars($request['civilstatus']); ?>"],
            ["Gender", "<?php echo htmlspecialchars($request['gender']); ?>"],
            ["Resident Number", "<?php echo htmlspecialchars($request['residentnumber']); ?>"],
            ["Precinct Number", "<?php echo htmlspecialchars($request['precinctnumber']); ?>"],
            ["Location", "<?php echo htmlspecialchars($request['location']); ?>"],
            ["Valid Until", "<?php echo $validuntil->format('F/j/Y'); ?>"],
            ["Status", "<?php echo htmlspecialchars($request['status']); ?>"],
            ["Paid", "<?php echo htmlspecialchars($request['paid']); ?>"],
        ...
        hiddenElement.download = `${requestNumber}-Barangay-ID-Request.csv`;
        hiddenElement.click();
    }
    ...
    function generatePDF() {
        ...
        doc.text("Barangay ID Request Details", 100, 17, null, null, "center"); // Centered header text

        // Fields for the request details
        const fields = [
            { label: "Request Number", value: "<?php echo htmlspecialchars($request['request_number']); ?>" },
            { label: "Username", value: "<?php echo htmlspecialchars($request['username']); ?>" },
            ...
            { label: "Middle Name", value: "<?php echo htmlspecialchars($request['middlename']); ?>" },
            { label: "Middle Initial", value: "<?php echo htmlspecialchars($request['middleinitial']); ?>" },
            { label: "Date of Birth", value: "<?php echo $dateofbirth->format('F j, Y'); ?>" },
            { label: "Civil Status", value: "<?php echo htmlspecialchars($request['civilstatus']); ?>" },
            { label: "Gender", value: "<?php echo htmlspecialchars($request['gender']); ?>" },
            { label: "Resident Number", value: "<?php echo htmlspecialchars($request['residentnumber']); ?>" },
            { label: "Precinct Number", value: "<?php echo htmlspecialchars($request['precinctnumber']); ?>" },
            { label: "Location", value: "<?php echo htmlspecialchars($request['location']); ?>" },
            { label: "Valid Until", value: "<?php echo $validuntil->format('F j, Y'); ?>" },
            { label: "Status", value: "<?php echo htmlspecialchars($request['status']); ?>" },
            { label: "Paid", value: "<?php echo htmlspecialchars($request['paid']); ?>" },
        ...
        doc.save(`${requestNumber}-Barangay-ID-Request.pdf`);
    }
</script>
</body>
</html>
