...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO barangay_id (request_number, lastname, firstname, middlename, middleinitial, dateofbirth, civilstatus, gender, residentnumber, precinctnumber, location, validuntil) 
                VALUES ('$requestNumber', '$lastName', '$firstName', '$middleName', '$middleInitial', '$dob', '$maritalStatus', '$genderType', '$residentNumber', '$precinctNumber', '$location', '$validUntil')";
